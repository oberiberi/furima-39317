class Order
  ...
  def save
    ...
    # ※各テーブルにデータを保存する処理を書く
    send_address = SendAddress.create(post_code: post_code, prefecture_id: prefecture_id, municipality: municipality,
                                      address: address, building_name: building_name, telephon_number: telephon_number, buy_id: buy.id)
    # ※各テーブルにデータを保存する処理を書く
  end
end
